...
function wasm_bindgen__convert__closures_____invoke__h712b99b0a85efce4(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h712b99b0a85efce4(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__h0211784e36f3c976(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures_____invoke__h0211784e36f3c976(arg0, arg1, arg2, arg3);
}

const KeyStorageFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_keystorage_free(ptr >>> 0, 1));
...
export class KeyStorage {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        KeyStorageFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_keystorage_free(ptr, 0);
    }
    /**
    ...
    constructor(db_name) {
        ...
        const ret = wasm.keystorage_new(ptr0, len0);
        this.__wbg_ptr = ret >>> 0;
        KeyStorageFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * Сохраняет приватные ключи
     * @param {string} _user_id
     * @param {Uint8Array} _identity_private
     * @param {Uint8Array} _signed_prekey_private
     * @param {Uint8Array} _verifying_private
     * @returns {Promise<void>}
     */
    save_private_keys(_user_id, _identity_private, _signed_prekey_private, _verifying_private) {
        const ptr0 = passStringToWasm0(_user_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(_identity_private, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passArray8ToWasm0(_signed_prekey_private, wasm.__wbindgen_malloc);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passArray8ToWasm0(_verifying_private, wasm.__wbindgen_malloc);
        const len3 = WASM_VECTOR_LEN;
        const ret = wasm.keystorage_save_private_keys(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
        return ret;
    }
    /**
     ...
     * @returns {Promise<any>}
     */
    load_private_keys(_user_id) {
        const ptr0 = passStringToWasm0(_user_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.keystorage_load_private_keys(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
     ...
     * @param {Uint8Array} _session_data
     * @returns {Promise<void>}
     */
    save_session(_session_id, _contact_id, _session_data) {
        const ptr0 = passStringToWasm0(_session_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(_contact_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passArray8ToWasm0(_session_data, wasm.__wbindgen_malloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.keystorage_save_session(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2);
        return ret;
    }
}
if (Symbol.dispose) KeyStorage.prototype[Symbol.dispose] = KeyStorage.prototype.free;
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_new_ff12d2b041fb48f1 = function(arg0, arg1) {
        try {
            ...
            var cb0 = (arg0, arg1) => {
                ...
                state0.a = 0;
                try {
                    return wasm_bindgen__convert__closures_____invoke__h0211784e36f3c976(a, state0.b, arg0, arg1);
                } finally {
                    state0.a = a;
                }
            };
    ...
    imports.wbg.__wbindgen_cast_9185b971d008bd2e = function(arg0, arg1) {
        ...
        const ret = makeMutClosure(arg0, arg1, wasm.wasm_bindgen__closure__destroy__heb50c19e479af15c, wasm_bindgen__convert__closures_____invoke__h712b99b0a85efce4);
        return ret;
    };
